...
public class OnboardingController {
	...
	@Operation(
			summary = "Get placement questions",
			description = "Returns DB-backed path questions for the given goal node (currentGoalNode)"
	)
	public OnboardingQuestionsResponse getQuestions(@RequestParam @Schema(defaultValue = "22222222-2222-2222-2222-222222220010") UUID goalNodeId) {
